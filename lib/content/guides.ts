...
import { guideMdxComponents } from "@/lib/content/mdx-components";
...
export function listGuidesByHub(hub: string): GuideFrontmatter[] {
  return listGuides().filter((g) => g.hub === hub);
}
